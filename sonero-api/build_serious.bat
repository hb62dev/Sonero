...
venv\Scripts\python.exe -m pip install -r requirements.txt --target build_python
venv\Scripts\python.exe -m pip install -r requirements-win.txt --target build_python
